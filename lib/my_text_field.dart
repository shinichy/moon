...
/// Signature for the [MyTextField.buildCounter] callback.
...
class _TextFieldSelectionGestureDetectorBuilder extends MyTextSelectionGestureDetectorBuilder {
  _TextFieldSelectionGestureDetectorBuilder({
    required _MyTextFieldState state,
  }) : _state = state,
        super(delegate: state);

  final _MyTextFieldState _state;
...
///
/// {@tool snippet}
/// This example shows how to create a [MyTextField] that will obscure input. The
...
class MyTextField extends StatefulWidget {
  ...
  /// [MyTextField.noMaxLength] then only the current length is displayed.
  ///
  ...
  const MyTextField({
    ...
    this.enableIMEPersonalizedLearning = true,
        ...
        assert(maxLength == null || maxLength == MyTextField.noMaxLength || maxLength > 0),
  ...
  /// to [MyTextField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforcement] is set to
  /// [MaxLengthEnforcement.none].
  ...
  /// which is evaluated after the supplied [inputFormatters], if any.
  ///
  /// This value must be either null, [MyTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [MyTextField.noMaxLength], then no limit will
  ...
  ///
  /// The [mouseCursor] is the only property of [MyTextField] that controls the
...
class _MyTextFieldState extends State<MyTextField> with RestorationMixin implements MyTextSelectionGestureDetectorBuilderDelegate, AutofillClient {
  ...
  @override
  final GlobalKey<MyEditableTextState> editableTextKey = GlobalKey<MyEditableTextState>();
  ...
  MyEditableTextState? get _editableText => editableTextKey.currentState;
